...
const Watch = () => {
    ...
    const channelProfilePicture = dummyChannelDetail.items[0].snippet.thumbnails.high.url || dummyChannelDetail.items[0].snippet.thumbnails.default.url


    return (
        <div className="w-full flex  justify-between mt-4 overflow-hidden">
            <div className="w-[75%] border-red-700 min-h-screen border-solid bg-black ">
                {/* embedded video plays here */}
                <ReactPlayer url={`https://www.youtube.com/watch?v=${videoID}`} width={"100%"} height={"80%"} controls playing></ReactPlayer>
